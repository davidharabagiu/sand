...
{
    SHA3HasherImpl sha3;
    std::string    hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_224, str_data_, str_.size()));
...
{
    SHA3HasherImpl sha3;
    std::string    hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_256, str_data_, str_.size()));
...
{
    SHA3HasherImpl sha3;
    std::string    hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_384, str_data_, str_.size()));
...
{
    SHA3HasherImpl sha3;
    std::string    hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_512, str_data_, str_.size()));
...
TEST_F(SHA3HasherTest, SHA3_224_HashStream)
{
    ...
    EXPECT_TRUE(fs.good());
    std::string hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_224, fs));
...
TEST_F(SHA3HasherTest, SHA3_256_HashStream)
{
    ...
    std::ifstream  fs {test_file_, std::ios::in | std::ios::binary};
    EXPECT_TRUE(fs.good());
    std::string hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_256, fs));
...
TEST_F(SHA3HasherTest, SHA3_384_HashStream)
{
    ...
    std::ifstream  fs {test_file_, std::ios::in | std::ios::binary};
    EXPECT_TRUE(fs.good());
    std::string hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_384, fs));
...
TEST_F(SHA3HasherTest, SHA3_512_HashStream)
{
    ...
    std::ifstream  fs {test_file_, std::ios::in | std::ios::binary};
    EXPECT_TRUE(fs.good());
    std::string hash = bytes_to_hex(sha3.hash(SHA3Hasher::SHA3_512, fs));
