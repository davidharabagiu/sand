...
\begin{figure}[H]
    \centering
    \scalebox{.33}{\includegraphics{figures/fig5}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{.33}{\includegraphics{figures/fig6}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{.33}{\includegraphics{figures/fig7}}
\end{figure}
...
\begin{figure}[H]
    \centering
    \scalebox{.33}{\includegraphics{figures/fig8}}
\end{figure}
